...
class ApiClient(object):
    ...
    def __call_api(
        ...
        self._request_start_time = datetime.datetime.now()

        config = self.configuration

        config.metrics_transaction_id = uuid.uuid4()
        ...
        # publishing metrics
        self._metric_url = url
        self.api_metric_publisher.build_metric(transaction_id=config.metrics_transaction_id,
        ...
        self.sdk_metric_publisher.build_metric(transaction_id=config.metrics_transaction_id,
                                               duration=datetime.datetime.now() - self._request_start_time,
                                               resource_path=self._metric_url, error_type=None, error_message=None,
                                               sdk_request_details=self._sdk_request_details,
                                               sdk_result_details=response_data.urllib3_response)
    ...
    def deserialize(self, response, response_type):
        ...
        try:
            ...
            self.sdk_metric_publisher.build_metric(transaction_id=self._transaction_id,
                                                   ...
                                                   sdk_request_details=self._sdk_request_details,
                                                   sdk_result_details=response.urllib3_response)
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                try:
                    klass = getattr(opsgenie_sdk.api, klass)
                except AttributeError:
                    klass = getattr(opsgenie_sdk.models, klass)
